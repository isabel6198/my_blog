...
La documentation a été réalisée à l'aide des balises Roxygen, et la description a été complétée ainsi :

![](description.png)

### Test

Dans la partie consacrée aux tests, un jeu de données est créé pour tester la fonction, possédant la même structure que celle reçue par **`perform_request`**. Les tests ont été validés sans présenter de problèmes.
