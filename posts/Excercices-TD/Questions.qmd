...
J'ai créé une nouvelle branche en plus de ma branche principale appelée "site", qui sert de support pour mon site. J'ai également mis en place le workflow GitHub Actions et la branche "gh-pages" pour mettre à jour ma page à chaque commit :)
